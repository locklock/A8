...
$(document).ready(function() {
	...
	$("#submit").click(function(){
		 ...
		 */
		$.post("rating.forthelichking",{method:"saveItemResult",userId:$("#userId").val(),"comment":$("#commit").val(),dataList:ret.join(","),procId:$("#procId").val(),instanceId:$("#instanceId").val()},function(data){
			if(!data){
				alert("保存失败");
			}else{
