...
<input type="button" id="submit" value=" 提 交 " style="width:50px;height:50px;size:25" width="50px" height="50px"></input>
...
<input type="hidden" id="instanceId" value="65535"/>
<input type="hidden" id="userId" value="65535"/>
</body>
</html>